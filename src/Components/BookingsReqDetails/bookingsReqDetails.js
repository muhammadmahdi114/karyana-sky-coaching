...
const BookingReqDetails = () => {
    ...
    useEffect(() => {
        const fetchBookingDetails = async () => {
            try {
                const response = await axios.get(`https://karyana-backend.vercel.app/get-booking-details/${bookingId}`);
    ...
    const handlePaymentStatusChange = async (status) => {
        try {
            await axios.put(`https://karyana-backend.vercel.app/update-payment-status/${bookingId}`, {
    ...
    const handleScheduleDateChange = async (newDate) => {
        try {
            await axios.put(`https://karyana-backend.vercel.app/update-schedule-date/${bookingId}`, {
    ...
    const handleAssignProvider = async () => {
        try {
            await axios.put(`https://karyana-backend.vercel.app/assign-provider/${bookingId}`, {
                providerId: provider,
            });
