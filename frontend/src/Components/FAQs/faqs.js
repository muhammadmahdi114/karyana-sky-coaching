...
export default function FAQs() {
    ...
    useEffect(() => {
        const fetchFAQs = async () => {
            try {
                const response = await axios.get(`${import.meta.env.backend_baseUrl}/get-faqs`);
    ...
    const handleAddFaq = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.backend_baseUrl}/add-faqs`, newFAQData, {
