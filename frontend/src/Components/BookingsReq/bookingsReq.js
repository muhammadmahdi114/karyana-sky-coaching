...
export default function BookingsReq() {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                const response = await axios.get(`${import.meta.env.backend_baseUrl}/get-bookings-req`);
        ...
        const fetchUsersAndProviders = async () => {
            try {
                const usersResponse = await axios.get(`${import.meta.env.backend_baseUrl}/get-users`);
                const providersResponse = await axios.get(`${import.meta.env.backend_baseUrl}/get-providers`);
    ...
    const handleAddBooking = async () => {
        try {
            const response = await axios.get(`${import.meta.env.backend_baseUrl}/latest-booking-id`);
            ...
            await axios.post(`${import.meta.env.backend_baseUrl}/add-bookings-req`, newBooking);
