...
export default function ServiceList() {
    ...
    useEffect(() => {
        const fetchServices = async () => {
            try {
                const response = await axios.get(`${import.meta.env.backend_baseUrl}/get-services`);
    ...
    const handleAddService = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.backend_baseUrl}/add-services`, newServiceData, {
                headers: {
